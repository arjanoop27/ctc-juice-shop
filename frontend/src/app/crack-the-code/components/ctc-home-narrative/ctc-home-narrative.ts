...
@Component({
  ...
  imports: [CommonModule, MatCardModule, MatButtonModule, MatIconModule, MatProgressSpinnerModule, MatDividerModule, MatListModule, MatProgressBar],
  standalone: true,
...
export class CtcHomeNarrative {
  ...
  progress$: Observable<{ completed: number; total: number; }> = this.api.getProgress()
